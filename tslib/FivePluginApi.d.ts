...
}, "sx" | "className" | "style" | "classes" | "children" | "disableGutters" | "button" | "tabIndex" | "autoFocus" | "disabled" | "action" | "selected" | "alignItems" | "dense" | "centerRipple" | "disableRipple" | "disableTouchRipple" | "focusRipple" | "focusVisibleClassName" | "LinkComponent" | "onFocusVisible" | "TouchRippleProps" | "touchRippleRef" | "ContainerComponent" | "ContainerProps" | "disablePadding" | "divider" | "secondaryAction" | "components" | "componentsProps" | "slotProps" | "slots">) => JSX.Element) & import("@mui/material/OverridableComponent").OverridableComponent<import("@mui/material").ExtendButtonBaseTypeMap<import("@mui/material/ListItem").ListItemTypeMap<{
    button: true;
