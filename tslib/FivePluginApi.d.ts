...
}, "className" | "style" | "classes" | "children" | "disableGutters" | "sx" | "button" | "tabIndex" | "autoFocus" | "disabled" | "action" | "selected" | "alignItems" | "dense" | "centerRipple" | "disableRipple" | "disableTouchRipple" | "focusRipple" | "focusVisibleClassName" | "LinkComponent" | "onFocusVisible" | "TouchRippleProps" | "touchRippleRef" | "components" | "componentsProps" | "slotProps" | "slots" | "divider" | "ContainerComponent" | "ContainerProps" | "disablePadding" | "secondaryAction">) => JSX.Element) & import("@mui/material/OverridableComponent").OverridableComponent<import("@mui/material").ExtendButtonBaseTypeMap<import("@mui/material/ListItem").ListItemTypeMap<{
    button: true;
